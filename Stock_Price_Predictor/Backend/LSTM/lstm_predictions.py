...
def lstm_predicted_results(normal_path, dataset_path, stock_symbol, number_of_days):
    ...
    model_dir = f'{normal_path}trained_lstm_models_with_sentiment'
    ...
    df = LSTM_Preprocess.preprocess_stock_data(tk,dataset_path)
    df_original = df.copy()

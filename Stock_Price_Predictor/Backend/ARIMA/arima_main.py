import pandas as pd
from ARIMA.arima_model import ARIMA_Preprocess

def arima_train(symbols,start_date, dataset_path):
    ...
    filtered_data, _ = ARIMA_Preprocess(tickers, start_date, p_d_q_values, output_directory, dataset_path)

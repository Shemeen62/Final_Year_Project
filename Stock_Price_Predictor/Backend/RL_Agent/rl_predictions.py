...
def make_future_predictions(stock_ticker, num_days, weights_directory, dataset_path):
...
def rl_agent_predicted_results(normal_path, dataset_path, stock_symbol, number_of_days):
    weights_directory = f"{normal_path}trained_rl_agent_models"
    ...
    predictions = make_future_predictions(user_ticker, user_days, weights_directory, dataset_path)

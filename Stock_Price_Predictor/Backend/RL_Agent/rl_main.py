...
def rl_agent_train(symbols, start_date, dataset_path):
    ...
    filtered_data = RL_Agent_Preprocess(ticker_symbols, pd.to_datetime(start_date), dataset_path)
    ...
    for ticker_symbol in ticker_symbols:
        ...
        train_agent(agent_dict[ticker_symbol], env_dict[ticker_symbol], total_episodes, episodes_per_batch, weights_directory, ticker_symbol)

...
def preprocess_stock_data(ticker, dataset_path):
    # Reading the data csv
    price_csv = f"{dataset_path}/{ticker}_Daily_Data.csv"
    news_csv = f"{dataset_path}/{ticker}_News_Content.csv"
    ...
    agg_functions = {
        'title': lambda x: ' '.join(x.astype(str)),  # Concatenate titles and convert to strings
        'summary': lambda x: ' '.join(x.astype(str)),  # Concatenate summaries and convert to strings

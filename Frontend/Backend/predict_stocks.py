...
def weighted_average_predictions(arima_predictions, lstm_predictions, rl_agent_predictions, weights=[0.3, 0.5, 0.2]):
...
if __name__ == "__main__":
    ...
    arima_predictions = arima_predicted_results(stock_symbol, number_of_days)
    lstm_predictions = lstm_predicted_results(stock_symbol, number_of_days)
    rl_predictions = rl_agent_predicted_results(stock_symbol, number_of_days)
